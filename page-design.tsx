...
// ΓöÇΓöÇΓöÇ Formatting Helpers ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
// ΓöÇΓöÇΓöÇ Micro-Components (Consumer/Fintech Style) ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
export default function TenantDashboardPage() {
  ...
  // ΓöÇΓöÇΓöÇ Computed Data ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
  ...
  // ΓöÇΓöÇΓöÇ Edge States (No Stay / Pending) ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
  ...
  if (stay.status === "APPROVED_AWAITING_PAYMENT") return (
    <div className="max-w-lg mx-auto p-6 md:p-10 pt-12">
      <h1 className="text-3xl font-bold mb-8">Welcome! ≡ƒÄë<br/><span className="text-gray-500 text-xl font-medium">Let's settle your first invoice.</span></h1>
  ...
  // ΓöÇΓöÇΓöÇ Main Dashboard (Consumer / Fintech Vibe) ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ

  return (
    <div className="min-h-screen bg-[#FAFAFA] dark:bg-[#0A0A0A] pb-32 text-[#111111] dark:text-white font-sans relative">
      
      {/* ΓöÇΓöÇ Top App Bar ΓöÇΓöÇ */}
              ...
              <div className="relative z-10">
                ...
                <div className="mt-6 flex gap-4 pt-6 border-t border-white/10">
                  ...
                  <div className="flex-1 border-l border-white/10 pl-4">
                    ...
                    <p className="text-sm font-bold">{nextDueDate ? formatDate(nextDueDate) : "ΓÇö"}</p>
                  </div>
                </div>
              </div>
            </div>
                      ...
                      <SoftCard key={p.id} className="p-4 flex items-center justify-between hover:scale-[1.01] transition-transform cursor-pointer">
                        ...
                        <div className="text-right">
                          <p className={`font-black text-[16px] ${isNeg ? "text-red-500" : "text-black dark:text-white"}`}>
                            {isNeg ? `ΓêÆ${formatCurrency(Math.abs(p.amountPaid))}` : `+${formatCurrency(p.amountPaid)}`}
                          </p>
      ...
      {/* ΓöÇΓöÇ Fixed Bottom Navigation Bar ΓöÇΓöÇ */}
