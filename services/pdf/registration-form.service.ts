...
export async function generateRegistrationForm(
  ...
  const data: RegistrationFormData = {
    ...
    tenant: {
      ...
      dateOfBirth: tenant.dateOfBirth ? tenant.dateOfBirth.toLocaleDateString("en-IN", { timeZone: "Asia/Kolkata" }) : "N/A",
      gender: tenant.gender || "N/A",
      placeOfBirth: tenant.placeOfBirth || "N/A",
      permanentAddress: tenant.permanentAddress || "N/A",
      emergencyContactName: tenant.emergencyContactName || "N/A",
      relationship: tenant.relationship || "N/A",
      emergencyContactNumber: tenant.emergencyContactNumber || "N/A",
      parentGuardianName: tenant.parentGuardianName || "N/A",
      parentGuardianContact: tenant.parentGuardianContact || "N/A",
      occupationType: tenant.occupationType || "STUDENT",
      ...
      purposeOfStay: tenant.purposeOfStay || "N/A",
      photoUrl,
    },
    accommodation: {
